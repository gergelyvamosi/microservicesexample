package org.gvamosi.microservicesexample.microservices.cassandra;
...
/**
 * @author Gergely Vamosi
 */
@Configuration
@PropertySource(value = { "classpath:cassandra.properties" })
@EnableCassandraRepositories(basePackages = { "org.gvamosi.microservicesexample.microservices.repositories" })
